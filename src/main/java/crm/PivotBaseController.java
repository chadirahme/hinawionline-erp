...
public class PivotBaseController extends SelectorComposer<Component>{
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        //return Arrays.asList(new String[] { "FullName", "Department", "Position"});
        
        pivotModel = new TabularPivotModel(pdata.getEmployeeList(),PivotData.getColumns());		
		pivotModel.setFieldType("FullName", PivotField.Type.COLUMN);
		pivotModel.setFieldType("Department", PivotField.Type.ROW);
		pivotModel.setFieldType("Position", PivotField.Type.ROW);
